...
import {Box, Button, Heading, Spinner,   useToast, SimpleGrid, Text
...
const DiscoverPerformers = () => {
    ...
    return loading ? (
        ...
        <Box id="discover" p="8">
            ...
            <Text>Explore a curated selection of extraordinary talents. From burlesque to exotic dancing, each performer is a maestro in their own right. Scroll through profiles, preview performances, and choose the perfect act for your desires.</Text>
